...
public class Processing {
    public void searchShortestWay() {
        ...
        class Pathfinding {
            ...
            private List<Field> closedList = new ArrayList<>();

            public List<Field> findPath(Field startField, Field endField, Map map) {
            ...
            private List<Field> getNeighbours(Map map, Field currentField) {
                ...
                if (currentField.getY() - 1 >= 0) neighbourList.add(map.map[currentField.getX()][currentField.getY() - 1]); // DOWN
                if (currentField.getY() + 1 < map.sizeY) neighbourList.add(map.map[currentField.getX()][currentField.getY() + 1]); // UP
                return neighbourList;
            }

            private int calculateDistanceCost(Field a, Field b) {
            ...
            private List<Field> calculatePath(Field endField) {
            ...
            private Field getLowestFCostField(List<Field> nodes) { // LAMBDA ONELINER?
